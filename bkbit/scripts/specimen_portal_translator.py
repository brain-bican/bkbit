...
class SpecimenPortal:
    ...
    def get_data(nhash_id, jwt_token):
        ...
        response = requests.get(
            f"{API_URL_PREFIX}{INFO_URL_SUFFIX}{nhash_id}", headers=headers
        )  # TODO: add timeout
...
if __name__ == "__main__":
    ...
    sp = SpecimenPortal(
        "eyJhbGciOiJIUzI1NiJ9.eyJ1c2VyX2lkIjoxMTAsImV4cCI6MTcxNTI5MzcwMX0.xquqUIIFsPynRc25SfU2GMqpg2gatSfldyYlqRhql8k"
    )
