...
class ParcellationAnnotationTermMap(ConfiguredBaseModel):
    ...
    """
    subject_parcellation_annotation: ParcellationAnnotation = Field(..., description="""Reference to the parcellation annotation that is the subject of the association.""")
