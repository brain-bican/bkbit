...
class AmplifiedCdnaRnaAmplificationPassFail(str, Enum):
    The_RNA_amplification_passed_the_QASOLIDUSQC = "Pass"
    The_RNA_amplification_failed_the_QASOLIDUSQC = "Fail"
    The_RNA_amplification_low_passed_the_QASOLIDUSQC = "Low QC"
    Library_Prep_not_evaluated_for_QASOLIDUSQC = "Not evaluated"
...
class DissociatedCellSampleCellPrepType(str, Enum):
    isolated_nuclei = "Nuclei"
    isolated_whole_cells = "Cells"


class DissociatedCellSampleCellLabelBarcode(str, Enum):
    number_10x_Cell_Plex_oligo_tag_for_multiplexing_tissue_sources_into_a_single_10x_loadFULL_STOP = "CMO312"
    Used_in_conjunction_with_Histone_antibody_to_capture_and_tag_separate_subcomponents_of_the_epigenomeFULL_STOP_Allows_for_pooling_of_enriched_cell_samples_into_a_single_10x_loadFULL_STOP = "3nt-006"
...
class LibraryPrepPassFail(str, Enum):
    Library_Prep_passed_the_QASOLIDUSQC = "Pass"
    Library_Prep_failed_the_QASOLIDUSQC = "Fail"
    Library_Prep_low_passed_the_QASOLIDUSQC = "Low QC"
    Library_Prep_not_evaluated_for_QASOLIDUSQC = "Not evaluated"


class LibraryR1R2Index(str, Enum):
    number_10x_Dual_Index_TT_Set_AFULL_STOP_Used_with_10xV3FULL_STOP1_10xV3FULL_STOP1_HT_and_10xMultiomeSEMICOLONGEX = "SI-TT-H12"
    number_10x_Dual_Index_NN_Set_AFULL_STOP_Used_with_10xV3FULL_STOP1_CellPlexSEMICOLONGEX_and_10xV3FULL_STOP1_HT_CellPlexSEMICOLONGEX = "SI-NN-H12"
    number_10x_Single_Index_N_Set_AFULL_STOP_Used_with_10xATAC_v2FULL_STOP0_and_10xMultiomeSEMICOLONATAC = "SI-NA-H12"
    NeryLab_384_SetB = "SetB-I7"
    NeryLab_384_SetBSOLIDUSNUMBER_SIGN = "SetB-I8"
